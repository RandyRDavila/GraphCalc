...
from graphcalc.graphs.generators.simple_graphs import (
    complete_graph,
    cycle_graph,
    path_graph,
    star_graph,
)
from graphcalc.graphs.invariants.degree import (
    degree,
    degree_sequence,
    average_degree,
    maximum_degree,
...
from graphcalc.graphs.invariants.graph_indices import harmonic_index
