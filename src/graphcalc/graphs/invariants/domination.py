# graphcalc/graphs/invariants/domination.py
...
from ..core import neighborhood, closed_neighborhood
from graphcalc.utils import enforce_type, GraphLike, _extract_and_report, SimpleGraph
...
@invariant_metadata(
    ...
    notation=r"\gamma(G)",
    category="domination",
    aliases=("graph domination number",),
    definition=(
        "The domination number gamma(G) of a graph G is the minimum cardinality "
...
@invariant_metadata(
    ...
    notation=r"\gamma_t(G)",
    category="domination",
    aliases=("graph total domination number",),
    definition=(
        "The total domination number gamma_t(G) of a graph G is the minimum "
        "cardinality of a set S such that every vertex of G has a neighbor in S."
    ),
)
...
@enforce_type(0, (nx.Graph, SimpleGraph))
@invariant_metadata(
    display_name="Independent domination number",
    notation=r"i(G)",
    category="domination",
    aliases=("graph independent domination number",),
    definition=(
...
@enforce_type(0, (nx.Graph, SimpleGraph))
@invariant_metadata(
    display_name="Connected domination number",
    notation=r"\gamma_c(G)",
    category="domination",
    aliases=("graph connected domination number",),
    definition=(
        "The connected domination number gamma_c(G) of a graph G is the minimum "
...
@enforce_type(0, (nx.Graph, gc.SimpleGraph))
@invariant_metadata(
    display_name="Outer-connected domination number",
    notation=r"\tilde{\gamma}_c(G)",
    category="domination",
    aliases=("graph outer-connected domination number",),
    definition=(
        "The outer-connected domination number of a graph G is the minimum "
        "cardinality of a dominating set S such that the subgraph induced by "
        "V(G) \\setminus S is connected."
    ),
)
...
@enforce_type(0, (nx.Graph, SimpleGraph))
@invariant_metadata(
    display_name="Roman domination number",
    notation=r"\gamma_R(G)",
    category="domination",
    aliases=("graph Roman domination number",),
    definition=(
        "The Roman domination number gamma_R(G) of a graph G is the minimum weight "
        "of a Roman dominating function on G."
    ),
)
...
@enforce_type(0, (nx.Graph, SimpleGraph))
@invariant_metadata(
    display_name="Double Roman domination number",
    notation=r"\gamma_{dR}(G)",
    category="domination",
    aliases=("graph double Roman domination number",),
    definition=(
        "The double Roman domination number gamma_dR(G) of a graph G is the minimum "
        "weight of a double Roman dominating function on G."
    ),
)
...
@enforce_type(0, (nx.Graph, SimpleGraph))
@invariant_metadata(
    display_name="Rainbow domination number",
    notation=r"\gamma_{r,k}(G)",
    category="domination",
    aliases=("k-rainbow domination number",),
    definition=(
        "The rainbow domination number gamma_{r,k}(G) of a graph G is the minimum "
        "number of colored vertices in a k-rainbow dominating function on G."
    ),
)
...
@enforce_type(0, (nx.Graph, SimpleGraph))
@invariant_metadata(
    display_name="2-rainbow domination number",
    notation=r"\gamma_{r,2}(G)",
    category="domination",
    aliases=("two rainbow domination number",),
    definition=(
        "The 2-rainbow domination number gamma_{r,2}(G) of a graph G is the minimum "
        "number of colored vertices in a 2-rainbow dominating function on G."
    ),
)
...
@enforce_type(0, (nx.Graph, SimpleGraph))
@invariant_metadata(
    display_name="3-rainbow domination number",
    notation=r"\gamma_{r,3}(G)",
    category="domination",
    aliases=("three rainbow domination number",),
    definition=(
        "The 3-rainbow domination number gamma_{r,3}(G) of a graph G is the minimum "
        "number of colored vertices in a 3-rainbow dominating function on G."
    ),
)
...
@enforce_type(0, (nx.Graph, SimpleGraph))
@invariant_metadata(
    display_name="Restrained domination number",
    notation=r"\gamma_r(G)",
    category="domination",
    aliases=("graph restrained domination number",),
    definition=(
        "The restrained domination number gamma_r(G) of a graph G is the minimum "
        "cardinality of a dominating set S such that the induced subgraph on "
        "V(G) \\setminus S has no isolated vertices."
    ),
)
...
@enforce_type(0, (nx.Graph, gc.SimpleGraph))
@invariant_metadata(
    display_name="Minimum maximal matching number",
    notation=r"\gamma(L(G))",
    category="domination",
    aliases=("minimum size of a maximal matching",),
    definition=(
        "The minimum maximal matching number of a graph G is the minimum cardinality "
