...
@invariant_metadata(
    display_name="Randić index",
    notation=r"R_{\alpha}(G)",
    category="graph indices",
    aliases=("generalized Randić index", "generalized connectivity index"),
    definition=(
        "The generalized Randić index R_alpha(G) of a graph G is the sum over all "
        "edges uv of (deg(u) deg(v))^alpha."
    ),
)
...
@invariant_metadata(
    display_name="First Zagreb index",
    notation=r"M_1(G)",
    category="graph indices",
    aliases=("Zagreb 1 index",),
    definition=(
        "The first Zagreb index M_1(G) of a graph G is the sum over all vertices v "
        "of deg(v)^2."
    ),
)
def zagreb_1(G):
...
@invariant_metadata(
    display_name="Second Zagreb index",
    notation=r"M_2(G)",
    category="graph indices",
    aliases=("Zagreb 2 index",),
    definition=(
        "The second Zagreb index M_2(G) of a graph G is the sum over all edges uv "
        "of deg(u) deg(v)."
    ),
)
def zagreb_2(G):
...
@invariant_metadata(
    display_name="Reciprocal first Zagreb index",
    notation=r"RM_1(G)",
    category="graph indices",
    aliases=("reciprocal Zagreb 1 index",),
    definition=(
        "The reciprocal first Zagreb index RM_1(G) of a graph G is the sum over "
        "all vertices v of 1/deg(v)^2, with isolated vertices contributing 0."
    ),
)
...
@invariant_metadata(
    display_name="Reciprocal second Zagreb index",
    notation=r"RM_2(G)",
    category="graph indices",
    aliases=("reciprocal Zagreb 2 index",),
    definition=(
        "The reciprocal second Zagreb index RM_2(G) of a graph G is the sum over "
        "all edges uv of 1/(deg(u)deg(v))."
    ),
)
...
@invariant_metadata(
    display_name="Atom-Bond Connectivity index",
    notation=r"\operatorname{ABC}(G)",
    category="graph indices",
    aliases=("ABC index",),
    definition=(
        "The Atom-Bond Connectivity index ABC(G) of a graph G is the sum over all "
        "edges uv of sqrt((deg(u)+deg(v)-2)/(deg(u)deg(v)))."
    ),
)
def abc_index(G):
    r"""
...
@invariant_metadata(
    display_name="Geometric-Arithmetic index",
    notation=r"\operatorname{GA}(G)",
    category="graph indices",
    aliases=("GA index",),
    definition=(
        "The Geometric-Arithmetic index GA(G) of a graph G is the sum over all "
        "edges uv of 2 sqrt(deg(u)deg(v)) divided by deg(u)+deg(v)."
    ),
)
def ga_index(G):
    r"""
...
@invariant_metadata(
    display_name="Reciprocal Geometric-Arithmetic index",
    notation=r"\operatorname{RGA}(G)",
    category="graph indices",
    aliases=("reciprocal GA index",),
    definition=(
        "The reciprocal Geometric-Arithmetic index RGA(G) of a graph G is the sum "
        "over all edges uv of (deg(u)+deg(v)) divided by 2 sqrt(deg(u)deg(v))."
    ),
)
...
@invariant_metadata(
    display_name="Sum-connectivity index",
    notation=r"SC_{\alpha}(G)",
    category="graph indices",
    aliases=("generalized sum-connectivity index",),
    definition=(
        "The generalized sum-connectivity index SC_alpha(G) of a graph G is the "
        "sum over all edges uv of (deg(u)+deg(v))^alpha."
    ),
)
...
@invariant_metadata(
    display_name="Sombor index",
    notation=r"\operatorname{SO}(G)",
    category="graph indices",
    aliases=("SO index",),
    definition=(
        "The Sombor index SO(G) of a graph G is the sum over all edges uv of "
        "sqrt(deg(u)^2 + deg(v)^2)."
    ),
)
def sombor_index(G):
    r"""
...
@invariant_metadata(
    display_name="Reciprocal Sombor index",
    notation=r"\operatorname{RSO}(G)",
    category="graph indices",
    aliases=("RSO index",),
    definition=(
        "The reciprocal Sombor index RSO(G) of a graph G is the sum over all edges "
        "uv of 1 divided by sqrt(deg(u)^2 + deg(v)^2)."
    ),
)
...
@invariant_metadata(
    display_name="Hyper Zagreb index",
    notation=r"\operatorname{HM}(G)",
    category="graph indices",
    aliases=("HM index",),
    definition=(
        "The Hyper Zagreb index HM(G) of a graph G is the sum over all edges uv of "
        "(deg(u)+deg(v))^2."
    ),
)
...
@invariant_metadata(
    display_name="Reciprocal Hyper Zagreb index",
    notation=r"\operatorname{RHM}(G)",
    category="graph indices",
    aliases=("reciprocal HM index",),
    definition=(
        "The reciprocal Hyper Zagreb index RHM(G) of a graph G is the sum over all "
        "edges uv of 1/(deg(u)+deg(v))^2."
    ),
)
...
@invariant_metadata(
    display_name="Augmented Zagreb index",
    notation=r"\operatorname{AZI}(G)",
    category="graph indices",
    aliases=("AZI index",),
    definition=(
        "The Augmented Zagreb index AZI(G) of a graph G is the sum over all edges "
        "uv of ((deg(u)deg(v))/(deg(u)+deg(v)-2))^3, with edges having "
        "deg(u)+deg(v)-2 <= 0 contributing 0."
    ),
)
...
@invariant_metadata(
    display_name="Reciprocal Augmented Zagreb index",
    notation=r"\operatorname{RAZI}(G)",
    category="graph indices",
    aliases=("reciprocal AZI index",),
    definition=(
        "The reciprocal Augmented Zagreb index RAZI(G) of a graph G is the sum over "
        "all edges uv of ((deg(u)+deg(v)-2)/(deg(u)deg(v)))^3."
    ),
)
...
@invariant_metadata(
    display_name="Harmonic index",
    notation=r"H(G)",
    category="graph indices",
    aliases=("graph harmonic index",),
    definition=(
        "The harmonic index H(G) of a graph G is the sum over all edges uv of "
        "2 divided by deg(u)+deg(v)."
    ),
)
def harmonic_index(G: GraphLike) -> float:
    ...
    33(6), 1006-1009 (1993).
    """
    return 2 * sum(1 / (G.degree(v) + G.degree(u)) for u, v in G.edges())
