...
Examples
--------
>>> from graphcalc.graphs.invariants import degree_sequence
...
from .critical_invariants import *
from .local_invariants import *
from .transversal_invariants import *
from .coloring_predicates import *
from .cycle_invariants import *
from .graph_indices import *
from .advanced_colorings import *
