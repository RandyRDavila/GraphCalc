...
@invariant_metadata(
    ...
    notation=r"\chi'(G)=\Delta(G)",
    category="edge colorings",
    aliases=("is class 1", "edge-chromatic class 1"),
    definition=(
        "A simple graph G is Class 1 if its edge-chromatic number chi'(G) equals "
        "its maximum degree Delta(G)."
    ),
)
...
@invariant_metadata(
    ...
    notation=r"\chi'(G)=\Delta(G)+1",
    category="edge colorings",
    aliases=("is class 2", "edge-chromatic class 2"),
    definition=(
        "A simple graph G is Class 2 if its edge-chromatic number chi'(G) equals "
        "Delta(G)+1, where Delta(G) is the maximum degree of G."
    ),
)
