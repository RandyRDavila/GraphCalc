# graphcalc/graphs/invariants/cycle_invariants.py
...
@invariant_metadata(
    display_name="Triangle count",
    notation=r"t(G)",
    category="cycles",
    aliases=("number of triangles",),
    definition=(
        "The triangle count t(G) of a graph G is the number of distinct "
        "unordered triples of vertices that induce a triangle."
    ),
)
...
@invariant_metadata(
    display_name="Cycle rank",
    notation=r"r(G)",
    category="cycles",
    aliases=("cyclomatic number",),
    definition=(
        "The cycle rank r(G) of an undirected graph G is |E(G)| - |V(G)| + c(G), "
...
@invariant_metadata(
    ...
    definition=(
        ...
        "If G is acyclic, its girth is infinite."
    ),
)
def girth(G):
    r"""
...
@invariant_metadata(
    display_name="Odd girth",
    notation=r"g_o(G)",
    category="cycles",
    aliases=("graph odd girth",),
    definition=(
        "The odd girth g_o(G) of a graph G is the minimum length of an odd cycle in G. "
        "If G has no odd cycle, its odd girth is infinite."
    ),
)
def odd_girth(G):
    r"""
...
@invariant_metadata(
    display_name="Even girth",
    notation=r"g_e(G)",
    category="cycles",
    aliases=("graph even girth",),
    definition=(
        "The even girth g_e(G) of a graph G is the minimum length of an even cycle in G. "
        "If G has no even cycle, its even girth is infinite."
    ),
)
def even_girth(G):
    r"""
...
@invariant_metadata(
    display_name="Circumference",
    notation=r"c(G)",
    category="cycles",
    aliases=("graph circumference", "longest cycle length"),
    definition=(
        "The circumference c(G) of a graph G is the maximum length of a simple "
        "cycle in G. If G is acyclic, its circumference is 0."
    ),
)
...
@invariant_metadata(
    display_name="Feedback vertex number",
    notation=r"\tau_V(G)",
    category="cycles",
    aliases=("minimum feedback vertex set size",),
    definition=(
        "The feedback vertex number tau_V(G) of a graph G is the minimum cardinality "
        "of a vertex set S such that G-S is acyclic."
    ),
)
...
@invariant_metadata(
    display_name="Maximum number of vertex-disjoint cycles",
    notation=r"\nu_{\circ}(G)",
    category="cycles",
    aliases=("cycle packing number", "vertex-disjoint cycle packing number"),
    definition=(
        "The maximum number of vertex-disjoint cycles of a graph G is the "
        "largest number of pairwise vertex-disjoint simple cycles contained in G."
    ),
)
...
@invariant_metadata(
    display_name="Decycling number",
    notation=r"\tau_V(G)",
    category="cycles",
    aliases=("feedback vertex number",),
    definition=(
        "The decycling number of a graph G is the minimum number of vertices that "
        "must be removed so that the remaining graph is acyclic."
    ),
)
...
@invariant_metadata(
    display_name="Maximum induced forest number",
    notation=r"f(G)",
    category="cycles",
    aliases=("induced forest number",),
    definition=(
        "The maximum induced forest number f(G) of a graph G is the maximum "
        "cardinality of a vertex subset U such that the induced subgraph G[U] is a forest."
    ),
)
